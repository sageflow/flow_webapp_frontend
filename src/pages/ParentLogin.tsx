...
const ParentLogin: React.FC = () => {
  ...
  // Get the intended destination from location state, or default to parent dashboard
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-8">
            ...
            <p className="text-body text-center mb-8">
              Secure login for parents & guardians
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary hover:bg-primary/90 text-white font-montserrat font-semibold py-3.5 px-6 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6"
              >
                {loading ? (
            ...
            <p className="text-center text-sm text-body mt-6">
              Not a user?{' '}
              <Link to="/signup/guardian" className="text-primary font-semibold hover:underline">
                Sign up
              </Link>
            </p>
          </div>
