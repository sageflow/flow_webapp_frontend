...
import { ArrowLeft, User, Lock, Users, Eye, EyeOff } from 'lucide-react'
...
const ParentLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login(formData, 'role_parent')
        ...
        >
          ...
          <div className="glass-card p-8">
            ...
            <div className="flex justify-center mb-5">
              <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-glow">
